...
audio_root = '/home/wgl/wav2lip-csattn/tmp'
...
def main():
    ...
    video_files = get_image_list(txtPath)
    ...
    for i, video_path in enumerate(video_files):
        ...
        audio = os.path.join(audio_root, '{}.mp3'.format(i))
        outfile = os.path.join(out_root, '{}.mp4'.format(i))
    ...
    print('test file length: {}, the number of completed: {}'.format(len(video_files), count))
