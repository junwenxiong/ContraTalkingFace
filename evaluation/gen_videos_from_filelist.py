...
parser.add_argument('--filelist', type=str, 
					help='Filepath of filelist file to read', default='/home/wgl/Wav2Lip-original/filelists/test.txt')
parser.add_argument('--results_dir', type=str, help='Folder to save all results into', 
									default='/home/wgl/Wav2Lip-original/test_results')
parser.add_argument('--data_root', type=str, default='/home/wgl/data/main/')
parser.add_argument('--checkpoint_path', type=str, 
					help='Name of saved checkpoint to load weights from', default='/home/wgl/Wav2Lip-original/checkpoints/wav2lip_gan.pth')
